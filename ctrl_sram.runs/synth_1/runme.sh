...
HD_PWD='C:/Users/lgehu/Documents/Polytech Dijon/SOC/ctrl_sram/ctrl_sram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ctrl_sram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ctrl_sram.tcl
